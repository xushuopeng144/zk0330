...
public class StringUtil {
	...
	public static boolean hasText(String src){
	 ...
	 public static char randomAChinese() {
		String str="";
		int highPos;
		int lowPos;
